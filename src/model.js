...
const googPrivateKey = (process.env.GOOGLE_PRIVATE_KEY) ? Buffer.from(process.env.GOOGLE_PRIVATE_KEY, 'base64').toString() : _.get(config, 'goog.analyticsTimezone')
const googClientEmail = (process.env.GOOGLE_CLIENT_EMAIL) ? Buffer.from(process.env.GOOGLE_CLIENT_EMAIL, 'base64').toString() : _.get(config, 'goog.clientEmail')
